...
import pagelogo from '../assets/image/footerlogo.png';
   
const Footer = () => {
  return (
    <footer class="bg-dblack mt-5" id="blog">d  
        <Container>
      <a href="#"><img src={pagelogo} alt="logo-footer" class="rotation-animation" /></a>
      <Row>
        <Col xl={5}>
          <p class="ff-poppins fs-l-sm fw-normal lh-185 text-white-grey2 mb-2 max-448">
          ...
          <div class="d-flex align-items-center gap-20 pt-4 my-contact gap-3">
            <a href="https://www.facebook.com/" target="_blank" class="text-decoration-none"><svg width="35" height="35"
            ...
            <a href="https://twitter.com/" target="_blank" class="text-decoration-none"><svg width="36" height="35"
            ...
            <a href="https://www.google.com/" target="_blank" class="text-decoration-none"><svg width="36" height="35"
                viewBox="0 0 36 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
        ...
        <Col xl={7}>
          <Row className=" foot-show">
            <Col lg={3} sm={6}>
              ...
              <ul class="ps-0 mb-0 pt-4">
                <li class="mb-3">
                  <a href="#" class="text-decoration-none text-white-grey1 ff-poppins fs-s-md fw-normal lh-150 position-relative footer-underline">Lorem
                    ipsum</a>
                </li>
                <li class="mb-3">
                  <a href="#" class="text-decoration-none text-white-grey1 ff-poppins fs-s-md fw-normal lh-150 position-relative footer-underline">Lorem
    ...
    <p class="text-white-grey1 text-center ff-poppins fs-s-md fw-normal lh-150 footerlastline mb-0 py-4">
