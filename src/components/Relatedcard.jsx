...
import cardshoes from '../assets/image/card-shoes.png'
import cardshoes2 from '../assets/image/card-shoes2.png'
const myimg = [{
img: cardshoes,
},
{
...
const Relatedcard = ()=> {
        ...
        <Col lg={3} md={6} className='pb-4'>
            <div className="product-card">
              <div className="position-relative overflow-hidden">
                ...
                <p className="text-white ff-poppins fs-m-sm fw-normal lh-34 bg-off-sale position-absolute mb-0">
                  -10% OFF
                </p>
                <p className="text-white ff-poppins fs-m-sm fw-normal lh-34 position-absolute new-text mb-0">
                  NEW
                </p>
              </div>
              <div className="prize-detail">
                <div className="d-flex align-items-center justify-content-between">
                  <div>
                    <p className="mb-0 color_primery_gray fs-s-md ff-poppins fw-medium lh-34">
                      Quickiins Mens Shoes
                    </p>
                    <p className="text-light-grey ff-poppins fs-s-md fw-medium lh-34 mb-0">
  ...
  return (
    <div className='py-5'>
        <Container>
            <h2 className='fs-m-lg fw-semibold ff-poppins text-black pb-4'>RELATED PRODUCT </h2>
            <Row>
                {mycard}
            </Row>
