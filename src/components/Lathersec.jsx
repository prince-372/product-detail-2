...
import bigred from '../assets/image/big-red-shoes.png';
import black from '../assets/image/black-small-shoes.png';
import red from '../assets/image/red-small-shoes.png';
import grey from '../assets/image/grey-small-shoes.png';
import redblack from '../assets/image/redblack-small-shoes.png';
import stars from '../assets/image/starts.png';

const Lathersec = () => {


  return (
  <section className="pt-2 mt-2 mt-md-4 pt-md-5 pb-1" id="home">
    <Container>
      <Row className='align-items-center'>
        <Col lg={6}>
          <img src={bigred} alt="red-big" className="w-100"/>  
          <div className='d-flex flex-wrap gap-3 pt-4'>
              <img src={black} alt="black-shoes" className=" rounded-1 color-macth "
                id="macth1" />
            
              <img src={red} alt="red-shoes" className=" rounded-1 color-macth " id="macth2" />
  
            
              <img src={grey} alt="greay-shoes" className=" rounded-1 color-macth "
                id="macth3" />

            
              <img src={redblack} alt="sneaker-type-shoes"
                className=" rounded-1 color-macth " id="macth4" />
            </div>
          </Col>
        <Col lg={6} >
          <h1 className="fs-m-lg fw-semibold ff-poppins color_black mb-1">
            PREMIUM MENS SPORTS LATHER KEDS
          </h1>
          <div className="d-flex align-items-center gap-2 pt-2 mb-1">
            <img src={stars} alt="5star" />
            <p className="mb-0 fs-m-md fw-normal ff-poppins text-light-black1 lh-134">
              ( 5 Customer Review )
            </p>
          </div>
          <p className="fs-m-md fw-normal ff-poppins text-white-grey-3 lh-185 pt-4 pb-3">
          ...
          <div className="d-flex align-items-center gap-4 pt-4">
            ...
            <div className="d-flex align-items-center gap-3 mb-1">
              <div className="add-box">
                <button
                  className=" text-grey fs-m-md fw-normal lh-125  border-0 bg-transparent"
                  id="decrease">
                  -
                </button>
                <p className="mb-0 text-grey fs-m-md fw-normal lh-125 d-flex align-items-center"
                  id="number">
                  1
                </p>
                <button
              ...
              <button className="fs-m-md fw-medium ff-poppins text-white cart-button lh-125" id="carto">
                Add to Cart
              </button>
            </div>
          </div>
          <div className="d-flex align-items-center gap-4 pt-3 mb-1 ">
            ...
            <div id="sizechart" className="d-flex align-items-center justify-content-between gap-5 position-relative add-box">
              <input type="text" list="size"
                className="fs-m-md ff_secandry fw-normal lh-125 color_secandary_gray border-0 mw-102" placeholder="S" />
              <datalist id="size">
          ...
          <div className="d-flex align-items-center pt-4 gap-4 border-custum-bottom pb-4">
            <div className="d-flex align-items-center">
              ...
              <p className="mb-0 text-light-black fs-l-sm fw-light lh-125 ff-poppins">Compare</p>
            </div>
            <div className="d-flex align-items-center">
              ...
              <p className="mb-0 text-light-black fs-l-sm fw-light lh-125 ff-poppins">Wishlist</p>
            </div>
          </div>
          <div className="d-flex align-items-center gap-4 pt-4 my-contact">
            ...
            <div className="d-flex gap-4">
              <a href="https://www.facebook.com/" target="_blank" className=""><svg width="23"
              ...
              <a href="https://twitter.com/" target="_blank" className=""><svg width="24" height="19"
              ...
              <a href="https://www.pinterest.com/pinartindia/" target="_blank" className=""><svg
              ...
              <a href="https://www.google.com/" target="_blank" className=""><svg width="30" height="29"
