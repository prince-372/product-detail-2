    ...
    <section className="pt-2 mt-2 mt-md-4 pt-md-5 pb-1" id="home">
      <Container>
        <Row className="align-items-center">
          <Col lg={6}>
            <img src={bigred} alt="red-big" className="w-100 mb-3" />
              <Row className="mb-3">
                <Col className="col-3">
              <img
                src={black}
                alt="black-shoes"
                className=" rounded-1 color-macth w-100"
                id="macth1"
              />
              </Col>
              <Col className="col-3">
          ...
          <Col lg={6}>
              ...
              <div className="d-flex align-items-center gap-3 mb-1">  
                <div className="add-box">
                  ...
                  <div className="mb-0 color_primery_gray fs_2xl fw-normal lh-25 ff_secandry d-flex align-items-center">
                    <p className="mb-0 small9 ff-3 fw-normal grey2">{count}</p>
                  </div>
                  <button
                ...
                <button
                  className="fs-m-md fw-medium ff-poppins text-white cart-button lh-125"
                  id="carto"
                >
                  Add to Cart
                </button>
            ...
            <div className="d-flex align-items-center gap-4 pt-3 mb-1 ">
              ...
              <select name="size" id="size" className="border-0 outline-0 size">
